...
describe('mfcc', function () {
  ...
  it('should return only 3 correct mfcc values given a valid signal', function (done) {
    var en = mfcc({
      sampleRate:44100,
      bufferSize:512,
      ampSpectrum:TestData.VALID_AMPLITUDE_SPECTRUM,
  ...
  it('should return only 40 correct mfcc values given a valid signal', function (done) {
    var en = mfcc({
      sampleRate:44100,
      bufferSize:512,
      ampSpectrum:TestData.VALID_AMPLITUDE_SPECTRUM,
