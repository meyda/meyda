...
describe('featureExtractors', function(){
  it('should provide all of the feature extractors', function(done){
  	...
  	featureExtractorsProvided.splice(featureExtractorsProvided.indexOf('extractorUtilities'), 1);

  	assert.sameMembers(Object.keys(featureExtractors),featureExtractorsProvided);
    done();
  });
});